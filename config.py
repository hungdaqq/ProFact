...
def get_option():
    ...
    parser.add_argument("--pretrained", type=str, default=True, help="pretained model")
    ...
    # dir setting
    parser.add_argument("--pth_dir", type=str, default="./checkpoint_save/")
    ...
    # data setting
    parser.add_argument("--img_size", type=int, default=512, help="train image size")

    # training setting
    parser.add_argument("--batch_size", type=int, default=1, help="batch size")
    parser.add_argument("--total_epoch", type=int, default=50, help="training epochs")
    parser.add_argument("--lr_init", type=float, default=1e-4, help="initilize lr")
    parser.add_argument("--lr_min", type=float, default=0, help="minimum lr")

    #
    parser.add_argument("--is_resume", type=bool, default=False, help="resume")
